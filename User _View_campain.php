            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="Add_Campain.php" class="btn btn-success pull-right">Back</a>
                        <a href="logout.php" class="btn btn-success pull-right">Logout</a>
                    </div>
                    <?php
                    require_once "Connaction.php";
                   $name = $_SESSION["username"];
                    $sql = "SELECT * FROM campaign WHERE usersname ='$name'";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<a href='Edit_campaign.php?id=". $row['id'] ."' title='Edit Campaign' data-toggle='tooltip'><span class='glyphicon glyphicon-pencil'></span></a>";
                                            echo "<a href='Delete_campain.php?id=". $row['id'] ."' title='Campaign Delete' data-toggle='tooltip'><span class='glyphicon glyphicon-trash'></span></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
